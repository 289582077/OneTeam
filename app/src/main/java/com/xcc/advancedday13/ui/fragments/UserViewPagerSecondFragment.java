...
import com.xcc.advancedday13.adapters.TravelsUserSecondAdapter;
...
public class UserViewPagerSecondFragment extends BaseFragment implements Handler.Callback, TravelsUserFirstAdapter.OnReadAllClicked {

    private static final String TAG = UserViewPagerSecondFragment.class.getSimpleName();
    private TravelsUserSecondAdapter adapter;
    ...
    private void initView() {
        ...
        mUserPtrrv.setLayoutManager(layoutManager);
        adapter = new TravelsUserSecondAdapter(getActivity(), null);
